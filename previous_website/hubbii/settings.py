"""
Django settings for hubbii project.
...
SECRET_KEY = 'django-insecure-s3p2zi43xr7*q3q2a$$hj!aoj)biakhc=(31bq+tb%)yb=uis4'
...
WSGI_APPLICATION = 'hubbii.wsgi.application'
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'default_secret_key_for_dev')
